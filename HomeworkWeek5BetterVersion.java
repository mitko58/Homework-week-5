...
public class HomeworkWeek5BetterVersion {
    ...
    private static void body(int[] arrayOfNumbers){
        Scanner scanner = new Scanner(System.in);
        ...
        while (isSystemOn) {
            ...
            if (numberOfOption == 1) {
                ...
                continueProgram(arrayOfNumbers);
                break;
    ...
    private static void continueProgram(int[] arrayOfNumbers) {
        Scanner scanner = new Scanner(System.in);
